...
class Index extends Component
{
    public User $user;
    use WithFileUploads;
    public $estados, $municipios, $parroquias, $comunas, $centros, $consejoComunales, $paises, $sexos, $generos, $enteros, $motivos, $especialidades = null;
    ...
    public function render()
    {
        ...
        if ($user->hasRole('admin')) {
            ...
            return view('livewire.doctor.perfil');
        } elseif ($user->hasRole('paciente')) {
            return view('livewire.paciente.perfil');
        }
    }
}
